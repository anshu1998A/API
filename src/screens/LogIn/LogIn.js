...
<SafeAreaView style={{flex:1}}>
    ...
    <View style={logInStyle.logInMain} >
      ...
      <ButtonComponent buttonText={strings.LOGIN} onpress={() => logInFun({ email, password })} dynamicStyle={true}  />
      <ButtonComponent buttonText={strings.SIGN_UP} onpress={signUp} dynamicStyle={true} />
